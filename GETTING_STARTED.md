...
- Open the repository on GitHub:
  `alytawakol92-dev/ntt-pricing-tool` (branch
  `claude/quotation-panel-design-tool-moy141`).
- Click the green **Code** button → **Download ZIP**.
- **Extract** the ZIP to a folder you can find, e.g. `Documents\NTT-Pricing-Tool`.
